...
=======
    text_content: Optional[List["NotebookDocumentCellContentChanges"]] = attrs.field(
        default=None
    )
    """Changes to the text content of notebook cells."""
>>>>>>> 1a6f18e (vNext LSP)
...
class NotebookDocumentFilterWithNotebook:
    ...
    cells: Optional[List["NotebookCellLanguage"]] = attrs.field(default=None)
    """The cells of the matching notebook to be synced."""
...
class NotebookDocumentFilterWithCells:
    ...
    cells: List["NotebookCellLanguage"] = attrs.field()
    """The cells of the matching notebook to be synced."""
